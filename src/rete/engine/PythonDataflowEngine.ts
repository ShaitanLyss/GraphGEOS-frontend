...
export type PythonDataflowEngineScheme = GetSchemes<
    Schemes['Node'],
    Schemes['Connection']
>
 ...
 * 
 */
export class PythonDataflowEngine<Schemes extends PythonDataflowEngineScheme> extends Scope<never, [Root<Schemes>]> {
