...
export class MakeArrayNode extends Node {
    ...
    override data(inputs?: Record<string, Input<Socket>> | undefined): Record<string, unknown> | Promise<Record<string, unknown>> {
    ...
    addPin() {
        ...
        this.addInData({ name: `data-${Object.keys(this.inputs).length}`, displayName: '', isArray: false, type: 'any' });
        this.height += 36;
