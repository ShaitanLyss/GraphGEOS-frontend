...
import GlobalPopup__SvelteComponent_ from './GlobalPopup.svelte';
...
export const globalPopupProps: Writable<{ content: ComponentType | string; arrow: boolean }> =
	writable({
		content: 'Missing global popup content',
		arrow: true
	});
