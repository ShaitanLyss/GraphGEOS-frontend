...
__decorate([PrimaryKey(), __metadata('design:type', String)], Graph.prototype, 'id', void 0);
__decorate(
...
__decorate(
	[Property({ type: types.boolean, default: true }), __metadata('design:type', Boolean)],
	Graph.prototype,
	'is_public',
	void 0
);
__decorate(
	[ManyToOne(() => User, { nullable: true }), __metadata('design:type', User)],
	Graph.prototype,
	'author',
	void 0
);
Graph = __decorate([Entity()], Graph);
export { Graph };
